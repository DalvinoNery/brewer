...
public class WebConfig extends WebMvcConfigurerAdapter implements ApplicationContextAware {
	...
	/**
	 * Mapeando para o spring procurar os recursos que nao tem controller em src/main/resources/static/..
	 */
	@Override
	...
	public MessageSource messageSource(){
		...
		bundle.setDefaultEncoding("UTF-8"); // http://www.utf8-chartable.de/ acentuação de mensagens de validação.
		return bundle;
	}
