//Cria objeto Brewer ou outro objeto caso Brewer já exista
var Brewer = Brewer || {};
...
Brewer.EstiloCadastroRapido = (function() {
	...
	EstiloCadastroRapido.prototype.iniciar = function() {
		...
		// para o modal não submeter quando apertar enter.
	...
	// abrir modal com focus no input nome.
	function onModalShow() {
		this.inputNomeEstilo.focus();
	}
	
	// limpar modal se fechar sem submeter
